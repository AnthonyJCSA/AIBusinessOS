export const metadata = {
  ...
  description: 'Sistema para boticas que controla ventas, stock y caja. Empieza hoy desde S/99 al mes. Soporte en Perú.',
  ...
  openGraph: {
    title: 'Sistema para Boticas en Perú | Coriva Core',
    description: 'Sistema para boticas que controla ventas, stock y caja. Empieza hoy desde S/99 al mes.',
    type: 'website',
    locale: 'es_PE',
