...
const WA = "https://wa.me/51913916967?text=Hola,%20tengo%20una%20botica%20y%20quiero%20digitalizar%20mi%20negocio%20con%20AI%20Business%20OS."

const plans = [
  {
    name: 'Pro', badge: '🔥 Más popular', price: 'S/ 99', old: 'Plan completo',
    ai: '🤖 IA Básica', aiDesc: 'Alertas de stock automáticas',
    feats: ['Control de ventas','Control de stock','Control de caja','Alertas stock bajo','Reportes OPPF/SNIPPF','Control de deudas','Facturación SUNAT','Módulo Farmacia DIGEMID','Soporte en Perú','Implementación incluida'],
    ...
    <section style={{ padding: '100px clamp(20px,5vw,80px)', background: C.bg2 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 2, color: C.orange, display: 'block', marginBottom: 16 }}>🚀 Planes para tu botica</span>
